/**
 * Dimm City — a Gutterpress plugin.
 *
 ...
 * for you. A prefix is what keeps `gp-dimm-city`'s callout from colliding with
 ...
 * `<span class="dc-term">key term</span>`.
 *
 ...
 */
export default function gpDimmCity(md, options = {}) {
  const termClass =
...
export const metadata = {
  name: "Dimm City",
  description: "Dimm City design system for Gutterpress",
};
